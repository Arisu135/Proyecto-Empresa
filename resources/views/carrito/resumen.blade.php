...
<body>
    ...
    <div class="max-w-xl w-full mx-auto mt-8 bg-white rounded-xl shadow-2xl overflow-hidden"> 
        ...
        <div class="p-6 md:p-8">
            <h2 class="text-xl font-bold text-brand-dark mb-6">Productos Añadidos:</h2> 
            ...
            <ul class="space-y-4 mb-6">
                @forelse ($carrito_items ?? [] as $itemKey => $item)
                    ...
                    <li class="border-b border-soft-border pb-4 last:border-b-0 flex justify-between items-start">
                        <div>
        ...
        <div class="p-6 md:p-8 pt-0 flex flex-col space-y-3">
            ...
            {{-- Formulario de Finalización (POST) con cambio de texto a "Ir a Pedidos" --}}
