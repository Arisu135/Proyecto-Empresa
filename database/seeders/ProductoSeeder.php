...
class ProductoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($calientesId) {
            Producto::create(['nombre' => 'Espresso', 'descripcion' => 'Café concentrado puro.', 'precio' => 4.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'espresso.png']);
            Producto::create(['nombre' => 'Café Americano', 'descripcion' => 'Café largo tradicional.', 'precio' => 5.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'americano.png']);
            Producto::create(['nombre' => 'Capuccino', 'descripcion' => 'Café con leche texturizada y canela.', 'precio' => 7.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'capuccino.png']);
            Producto::create(['nombre' => 'Cafe Mocca', 'descripcion' => 'Café, leche y chocolate.', 'precio' => 8.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'cafe_mocca.png']);
            Producto::create(['nombre' => 'Café Bombom', 'descripcion' => 'Café con leche condensada.', 'precio' => 8.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'cafe_bombom.png']);
            Producto::create(['nombre' => 'Matcha Milk', 'descripcion' => 'Té matcha con leche, caliente o frío.', 'precio' => 8.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'matcha_milk.png']);
            Producto::create(['nombre' => 'Submarino', 'descripcion' => 'Leche caliente con barra de chocolate.', 'precio' => 8.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $calientesId, 'imagen_nombre' => 'submarino.png']);
        ...
        if ($jugosId) {
            ...
            Producto::create(['nombre' => 'Jugo de Platano', 'descripcion' => 'Jugo de plátano con leche.', 'precio' => 7.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $jugosId, 'imagen_nombre' => 'jugo_platano.png']);
        ...
        if ($limonadasId) {
            ...
            Producto::create(['nombre' => 'Limonada Cherry', 'descripcion' => 'Limonada con sabor a cereza.', 'precio' => 7.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $limonadasId, 'imagen_nombre' => 'limonada_cherry.png']);
        ...
        if ($bebidasHeladasId) {
            ...
            Producto::create(['nombre' => 'Iced Cappuccino', 'descripcion' => 'Cappuccino frío.', 'precio' => 9.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'iced_cappuccino.png']);
            Producto::create(['nombre' => 'Iced Mocaccino', 'descripcion' => 'Mocaccino frío con crema batida.', 'precio' => 10.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'iced_mocaccino.png']);
            Producto::create(['nombre' => 'Iced Matcha Milk', 'descripcion' => 'Matcha con leche fría.', 'precio' => 10.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'iced_matcha_milk.png']);
            Producto::create(['nombre' => 'Blueberry Matcha', 'descripcion' => 'Matcha fría con arándanos.', 'precio' => 11.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'blueberry_matcha.png']);
            Producto::create(['nombre' => 'Matcha y Mango', 'descripcion' => 'Matcha fría con pulpa de mango.', 'precio' => 11.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'matcha_mango.png']);
            Producto::create(['nombre' => 'Rebel Sky', 'descripcion' => 'Bebida fría y colorida de fantasía.', 'precio' => 8.00, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $bebidasHeladasId, 'imagen_nombre' => 'rebel_sky.png']);
        ...
        if ($frappeId) {
            ...
            Producto::create(['nombre' => 'Frappe de Chocolate', 'descripcion' => 'Frappé clásico de chocolate.', 'precio' => 9.90, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $frappeId, 'imagen_nombre' => 'frappe_chocolate.png']);
            Producto::create(['nombre' => 'Frappe de Capuccino', 'descripcion' => 'Frappé con sabor a capuccino.', 'precio' => 9.90, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $frappeId, 'imagen_nombre' => 'frappe_capuccino.png']);
        ...
        if ($postresId) {
            ...
            Producto::create(['nombre' => 'Torta de Chocolate', 'descripcion' => 'Porción de torta clásica de chocolate.', 'precio' => 8.00, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'torta_chocolate.png']);
            Producto::create(['nombre' => 'Torta de Chocolate Helado', 'descripcion' => 'Torta de chocolate servida fría.', 'precio' => 9.50, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'torta_chocolate_helado.png']);
            Producto::create(['nombre' => 'Tiramisu', 'descripcion' => 'Postre italiano a base de café y queso.', 'precio' => 9.50, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'tiramisu.png']);
            Producto::create(['nombre' => 'Tocino del Cielo', 'descripcion' => 'Postre tradicional tipo flan.', 'precio' => 7.00, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'tocino_cielo.png']);
            Producto::create(['nombre' => 'Pie de Limón', 'descripcion' => 'Porción de pie de limón con merengue.', 'precio' => 8.00, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'pie_limon.png']);
            Producto::create(['nombre' => 'Carlota', 'descripcion' => 'Postre frío de limón o frutas.', 'precio' => 8.00, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'carlota.png']);
            Producto::create(['nombre' => 'Fresa con Chocolate', 'descripcion' => 'Fresas frescas bañadas en chocolate.', 'precio' => 9.50, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'fresa_chocolate.png']);
            Producto::create(['nombre' => 'Fresa con Vainilla', 'descripcion' => 'Fresas con crema batida sabor vainilla.', 'precio' => 9.50, 'categoria' => 'Postres', 'disponible' => 1, 'categoria_id' => $postresId, 'imagen_nombre' => 'fresa_vainilla.png']);
        ...
        if ($saladosId) {
            ...
            Producto::create(['nombre' => 'Sandwich de Pollo', 'descripcion' => 'Sándwich de pollo desmenuzado.', 'precio' => 9.50, 'categoria' => 'Individual', 'disponible' => 1, 'categoria_id' => $saladosId, 'imagen_nombre' => 'sandwich_pollo.png']);
        ...
        if ($rebelBubblesId) {
            ...
            Producto::create(['nombre' => 'Frutos Rojos Tea', 'descripcion' => 'Té de frutos rojos con bubbles.', 'precio' => 10.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $rebelBubblesId, 'imagen_nombre' => 'frutos_rojos_tea_bubbles.png']);
            Producto::create(['nombre' => 'Menta Tea', 'descripcion' => 'Té de menta con bubbles.', 'precio' => 10.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $rebelBubblesId, 'imagen_nombre' => 'menta_tea_bubbles.png']);
            Producto::create(['nombre' => 'Matcha Bubbles', 'descripcion' => 'Bebida de Matcha con bubbles.', 'precio' => 13.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $rebelBubblesId, 'imagen_nombre' => 'matcha_bubbles.png']);
            Producto::create(['nombre' => 'Blueberry Bubbles', 'descripcion' => 'Bebida sabor arándanos con bubbles.', 'precio' => 13.50, 'categoria' => 'Bebidas', 'disponible' => 1, 'categoria_id' => $rebelBubblesId, 'imagen_nombre' => 'blueberry_bubbles.png']);
